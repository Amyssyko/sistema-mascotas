...
export default function CustomNavbar() {
	...
	const navList = (
		<ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
			...
			<Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
				<a href="/mascotas" className="flex items-center">
					Mascotas
				</a>
			</Typography>
			<Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
				<a href="/informacion" className="flex items-center">
					Información
				</a>
			</Typography>
			<Typography as="li" variant="small" color="blue-gray" className="p-1 font-normal">
				<a href="/peticion" className="flex items-center">
					Peticiones
				</a>
			</Typography>
		</ul>
			...
			<div className="flex items-center justify-between text-blue-gray-900">
				<div className="flex items-center justify-center flex-col ">
					...
					<Typography
						as="a"
						href="/"
						className="mr-4 cursor-pointer py-1.5 text-white text-center w-auto mx-auto"
					>
						Mi Mascota Feliz
					</Typography>
				</div>
