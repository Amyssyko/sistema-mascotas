...
-- CreateEnum
CREATE TYPE "StatusAdoption" AS ENUM ('Recibida', 'Tramitando', 'Completa', 'Rechazado');

-- CreateEnum
CREATE TYPE "PetStatus" AS ENUM ('Perdido', 'Encontrado');
...
CREATE TABLE "Post" (
    ...
    "userId" INTEGER,
    "petId" INTEGER,
    "postDate" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
    "postUpdate" TIMESTAMP(3),
...
CREATE TABLE "Adoption" (
    ...
    "status" "StatusAdoption" NOT NULL DEFAULT 'Tramitando',
    "personDni" VARCHAR(10),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "LostPet" (
    ...
    "location" TEXT,
    "description" TEXT,
    "status" "PetStatus" NOT NULL DEFAULT 'Perdido',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
